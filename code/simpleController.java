...
public class simpleController implements Initializable{
	...
	public void best() {
		if(min<bestmin) {
			...
			MenuCotroller.onemin=min;
			MenuCotroller.onesec=sec;
			rec.setVisible(true);
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		if(MenuCotroller.onemin!=1000) {
			bestmin=MenuCotroller.onemin;
			bestsec=MenuCotroller.onesec;
			BS.setText("BestScore:"+String.format("%02d",MenuCotroller.onemin)+":"+String.format("%02d", MenuCotroller.onesec));
		}
		blood=100;
		record=0;
		...
		MakeZ=new Timeline(new KeyFrame(Duration.millis(1000),(e)->{
			int i = (int) (Math.random() * (681));
			int m=(int)(Math.random()*2);
			Image img = new Image("file:C:\\Users\\dell\\Desktop\\javaTest\\javatest\\src\\project\\Mzombie.png");
		...
		Attack=new Timeline(new KeyFrame(Duration.millis(400),(e)->{
			for(var Z :zombies) {
